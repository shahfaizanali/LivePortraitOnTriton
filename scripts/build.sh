...
docker run --gpus=all -d --name live-triton -v /avatar/checkpoints:/LivePortraitOnTriton/checkpoints -v /avatar/images:/LivePortraitOnTriton/images --network host -e PORT=8082 live-portrait:triton